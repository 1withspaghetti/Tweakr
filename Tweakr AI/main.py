...
# Create new directories for train and test data
...
# Plot the images with original class labels
...
# Update class labels in the test data
test_data.classes = [format_label(c) for c in test_data.classes]
classes = test_data.classes

# Plot the images with formatted class labels
# plot_images(images, labels, classes)
